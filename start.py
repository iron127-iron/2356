...
__ip__: Any = None
__android__: bool = 'android' in _platform.lower() or 'linux' == _platform.lower() and Path('/data/data/com.termux').exists()
tor2webs = [
            'onion.city',
            'onion.cab',
            'onion.direct',
...
# Add vendored libs path for Android APK
_libs_path = __dir__ / 'libs'
        ...
        with suppress(IndexError):
            ...
            if method in Methods.LAYER7_METHODS:
                ...
                if __android__:
                    ...
                    if not bombardier_path.exists():
                        bombardier_path = Path("/data/data/com.termux/files/usr/bin/bombardier")
                else:
                    bombardier_path = Path.home() / "go/bin/bombardier"
                proxies: Any = set()
